...
`awo init --key PROM`. It does **not** contain product code; it links to
...
| `awo req new` → `awo goal new --from PROM-R#` → `awo goal plan PROM-G#` | Requirement → Goal → Tasks. |
| `awo task run PROM-T#` | Execute a task; writes a log. |
